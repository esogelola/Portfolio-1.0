        <section class="footer">
          <div class="container">
            <div class="row ">
              <div class="col-lg-6">
                <p class="mb-0">Copyrights © <?= date("Y") ?>. Emmanuel Sogelola</p>
                <p class="d-none"> Icons made by <a href="https://www.flaticon.com/authors/popcorns-arts" title="Icon Pond">Icon Pond</a> from <a href="https://www.flaticon.com/" title="Flaticon"> www.flaticon.com</a> </p>
              </div>
              <div class="col-lg-6">
        ...
        <!-- Core JS (JQuery / Easing, Popper, Bootstrap, AOS, Shuffle, Appear, isotope, smooth-scroll) -->
